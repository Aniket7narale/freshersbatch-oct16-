...
class HeightComparator implements Comparator<Person>{
    ...
    public static void main(String[] args) {
        ...
        set.add(new Person("Aniket Narale",165,70.5));
        set.add(new Person("prajwal bawner",167,63.8));
        set.add(new Person("akshay narale",172,80.9));
        set.add(new Person("tejas gautam",162,50.5));
        set.add(new Person("shivam hajare",170,50.5));
        set.add(new Person("rohit kadu",162,51.5));
        set.add(new Person("Aryan khan",162,53.5));
